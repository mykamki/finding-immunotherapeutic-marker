...
Rscript quality_control_single_seq_subset_and_normalization.R ../Output/SC1/ BC1 200 7500 10 ~/ANALYSIS/singlecell/Rdata/sc1/
Rscript quality_control_single_seq_subset_and_normalization.R ../Output/SC2/ BC2 1000 6000 10 ~/ANALYSIS/singlecell/Rdata/sc2/
Rscript quality_control_single_seq_subset_and_normalization.R ../Output/SC3/ BC3 500 6000 10 ~/ANALYSIS/singlecell/Rdata/sc3/
Rscript quality_control_single_seq_subset_and_normalization.R ../Output/SC4/ BC4 700 3000 10 ~/ANALYSIS/singlecell/Rdata/sc4/
Rscript quality_control_single_seq_subset_and_normalization.R ../Output/SC5/ BC5 500 4000 10 ~/ANALYSIS/singlecell/Rdata/sc5/
Rscript quality_control_single_seq_subset_and_normalization.R ../Output/SC6/ BC6 500 5000 7.5 ~/ANALYSIS/singlecell/Rdata/sc6/
Rscript quality_control_single_seq_subset_and_normalization.R ../Output/SC7/ BC7 400 4000 10 ~/ANALYSIS/singlecell/Rdata/sc7/
