...
mkdir $outdir
Rscript run_scissor.R ../ ~/ANALYSIS/singlecell/Rdata/integ_3000_mt/dim30/rm_epi/preprocessed_data1.RData null ~/ANALYSIS/singlecell/RESULT/GSE176307/BACI165_2/
[1] "|**************************************************|"
